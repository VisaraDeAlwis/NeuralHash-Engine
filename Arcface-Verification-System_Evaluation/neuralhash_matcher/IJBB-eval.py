...
# Define constants
IJB_DIR = "D:\FYP\Madusha_ArcFace_Evaluation\Arcface-Verification-System_Evaluation\datasets\ijb-testsuite\ijb\IJBB"
META_DIR = os.path.join(IJB_DIR, "meta")
MASTER_ROSTER_FILE = os.path.join(IJB_DIR, "meta", "ijbb_face_tid_mid.txt")
PAIR_LABEL_FILE = os.path.join(IJB_DIR, "meta", "ijbb_template_pair_label.txt")
